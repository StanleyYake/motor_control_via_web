...
#define dio_page  			"<!DOCTYPE html>"\
							"<html>"\
								...
								"<body>"\
                                    ...
                                    "<br>"\
                                    "<br>"\
                                    "<input type='button' value='Fan Off' pin='4' val= '1' onclick='setDiostate(this);'>"\
                                    "<br>"\
                                    "<br>"\
									"<input type='button' value='Fan On Level 1' pin='1' val='0' onclick='setDiostate(this);'> "\
									"<input type='button' value='Fan On Level 2' pin='2' val= '1' onclick='setDiostate(this);'> "\
                                    "<input type='button' value='Fan On Level 3' pin='3' val= '1' onclick='setDiostate(this);'> "\
									"</div>"\
									"<!-- to do -->"\
								"</body>"\
							"</html>"
